...
def clustering_count():
    ...
    s3 = boto3.client('s3', aws_access_key_id=aws_id, aws_secret_access_key=aws_secret)
    obj = s3.get_object(Bucket='data-science-team1', Key='finalcounts_jobpostings.csv')
    data = obj['Body'].read()
    ...
    transfer.upload_file('fintech_keywordcount_with_feature_engineering.csv', 'data-science-team1', 'fintech_keywordcount_with_feature_engineering')
