...
def cleanandprepboa(keywordslocation, listid):
    boascrapeddf = pd.read_excel("BOAScrapeUrlwithDesc.xlsx")
...
if __name__ == '__main__':
    path = None
    df_1_JP_Morgan = read_csv('totalaggregate_final.csv', r'..\Documents_Top_100\100_word_count.csv', 1)
    df_2_JP_Morgan = read_csv('totalaggregate_final.csv', r'..\Documents_Top_100\100_TF_IDF.csv', 1)
    df_3_JP_Morgan = read_csv('totalaggregate_final.csv', r'..\Documents_Top_100\100_text_rank.csv', 3)
    df_1_Bofa = cleanandprepboa("100_text_rank.csv", 3)
    df_2_Bofa = cleanandprepboa("100_TF_IDF.csv", 2)
    df_3_Bofa = cleanandprepboa("100_word_count.csv", 1)
